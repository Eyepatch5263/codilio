...
const CommentForm = ({ isSubmitting, onSubmit }: CommentFormInterface) => {
  ...
  return (
    <form onSubmit={handleSubmit} className='mb-7'>
      <div className="bg-slate-800 rounded-xl border border-[#ffffff0a] overflow-hidden">
        {/* Comment form header */}
        ...
        {isPreview ? (
          ...
          <textarea
            ...
            resize-none min-h-[120px] p-4 text-sm"
          />
        )}
