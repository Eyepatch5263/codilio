...
import { LANGUAGE_CONFIG,defineMonacoThemes } from '@/app/(root)/_constants/page'
        ...
        <div className="min-h-screen bg-[#0a0a0f]">
            ...
            <main className="max-w-[90rem] mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12">
                <div className="max-w-[1200px] mx-auto">
                    {/* Header */}
                    <div className="bg-slate-900/70 border border-[#ffffff0a] rounded-2xl p-6 sm:p-8 mb-6 backdrop-blur-xl">
                    ...
                    {/* Code Editor */}
                    <div className="mb-8 rounded-2xl overflow-hidden border border-[#ffffff0a] bg-slate-900/70">
