...
import SnippetsPageSkeleton from './_components/SnippetsPageSkelton'
...
const SnippetPage = () => {
    ...
    const filteredSnippets = snippets!.filter((snippet) => {
        ...
        const macthesLanguage = !selectedLanguage || snippet.language === selectedLanguage
        return macthesSearch && macthesLanguage
    })
