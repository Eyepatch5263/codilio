...
function NavigationHeader() {
    return (
        <div className="sticky top-0 py-4 z-50 w-full border-b border-gray-800/50 bg-gray-950/80 backdrop-blur-xl backdrop-saturate-150">
            ...
            <div className="max-w-7xl mx-auto px-4">
              ...
              group-hover:opacity-100 transition-all duration-500 blur-xl"
                 ...
                 from-blue-400 via-blue-300 to-purple-400 text-transparent bg-clip-text"
                        ...
                        <Link
                            href="/snippets"
                            className="relative group flex items-center gap-2 px-6 py-2.5 rounded-lg text-gray-300 bg-slate-800/20 hover:bg-blue-500/10 
