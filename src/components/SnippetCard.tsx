    ...
    return (
        ...
        >
            <Link href={`/snippets/${snippet._id}`} className="h-full block">
                <div
                    className="relative h-full bg-slate-900/60 backdrop-blur-sm rounded-xl 
                   ...
                   group-hover:to-purple-500/20 transition-all duration-500"
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative group/code">
                                ...
                                <pre className="relative bg-black/40 hover:border-gray-700 hover:border rounded-lg p-4 overflow-hidden text-sm text-gray-300 font-mono line-clamp-3">
                                    {snippet.code}
                                </pre>
                            </div>
                        </div>
